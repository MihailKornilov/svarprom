...
$(document).on('click', '.aajax', function () {
    var send = {
        p:'aajax',
        val:$(this).attr('val')
    };
...
$(document).on('click', '#logotext_save', function () {
    var but = $(this);
...
$(document).on('click', '#page_name_add button', function () {
    var but = $(this);
    if(but.hasClass('busy')) return;
    var send = {
        p:'page_name_add',
...
$(document).on('click', '.page_show_check', function () {
    var send = {
        p:'page_show_check',
        id:$(this).attr('val'),
...
$(document).on('click', '#a-catalog-add', function (){
    obj = $('#galery-catalog-add');
    obj[obj.is(':hidden') ? 'show' : 'hide']();
});

$(document).on('click', '#galery-catalog-add-submit', function (){
    var but = $(this);
    if(but.hasClass('busy')) return;
    var send = {
...
$(document).on('click', '#admin_galery .check', function () {
    var send = {
...
$(document).on('change', '#galery_upload_file', function () {
    cursorWait();
    $("#upload_form").submit();
...
$(document).on('click', '#backfon', imageClose);
